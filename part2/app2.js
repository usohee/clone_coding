...
console.log(String(30), 30); //타입 변환

console.log("나는 " + 30 + "살입니다."); //타입 강제
console.log("20" - 5.5);
...
console.log(booleanIsTrue == stringIsTrue); // false, "stringtrue" is converted to NaN, while booleantrue is converted to 1
...
const a5 = "Cat" && "Dog"; // true && 'Dog' -> t && t는 Dog 반환 (왼쪽이 true이면 오른쪽이 boolean타입이 아닐 때는 그 타입을 유지)
